# Contributing to EtlCpp

Thank you for your interest in contributing to EtlCpp! We welcome contributions
...
1. **Fork the repository:** Start by forking the EtlCpp repository on GitHub. This creates your own copy of the project that you can modify.
...
3.  **Create a pull request:**  Go to the EtlCpp repository on GitHub and create a pull request from your branch to the `main` branch.  Provide a clear description of your changes and reference any relevant issues.
